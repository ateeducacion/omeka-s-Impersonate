...
Read [impersonation-session](.agents/skills/impersonation-session/SKILL.md) when you need to: change login-as permissions, CSRF checks, session switching, or identity restoration.
